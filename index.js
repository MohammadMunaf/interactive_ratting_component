...
const submit = document.querySelector('.rounded-pill');
const thyou = document.querySelector('.thyou');
const rate = document.querySelector('.ratting');
thyou.style.display = 'none';
thyou.style.visibility = 'hidden';
...
submit.addEventListener('click', () => {
    ...
    rate.innerText = val;
    thyou.style.display = 'block';
    thyou.style.visibility = 'visible';
})
